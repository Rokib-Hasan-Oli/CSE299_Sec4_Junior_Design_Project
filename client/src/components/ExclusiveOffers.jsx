  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align='left' title='Exclusive Offers' subtitle='Grab Ghurbo’s limited-time deals and custom tour packages to make your journey affordable, exciting, and truly unforgettable.' />
            <button>
                View All Offers
                <img src={assets.arrowIcon} alt="arrow-iocn" className='group-hover:translate-x-1 transition-all ' />
            </button>
        </div>
