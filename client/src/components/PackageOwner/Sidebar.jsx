...
const Sidebar = () => {
    ...
    const sidebarLinks = [
        ...
        {name: "Add Package" , path: "/owner/add-package", icon: assets.addIcon},
        {name: "List Package" , path: "/owner/list-package", icon: assets.listIcon}
    ]
  return (
    <div className='md:w-64 w-16 border-r h-full text-base border-gray-300 pt-10 flex flex-col transition-all duration-300'>
