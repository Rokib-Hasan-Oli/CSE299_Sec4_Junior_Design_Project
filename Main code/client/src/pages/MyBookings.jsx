    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='max-w-6xl mx-8 w-full text-gray-800'>
           <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
               <div className="w-1/3"> Packages </div>
            ...
            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'> 
              {/*------ Package Details ------*/}
                <div className='flex flex-col md:flex-row'>
                  <img src={booking.room.images[0]} alt="package-img" className='min-md:w-44 rounded shadow object-cover' /> 
                  <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                    ...
                    <p className='text-base'> Total:  ৳ {booking.totalPrice} /Taka </p>
                  </div>
                </div>
              {/*------ Date & Timings ------*/}
