  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            ...
            {/*Room Price */}
            <p className='text-2xl font-medium'>${room.pricePerNight}/Per Person </p>
        ...
        mx-auto mt-16 max-w-6xl'>
            ...
            md:items-center gap-4 md:gap-10 text-gray-500'>
                <div className='flex flex-col'>
                    <label htmlFor="checkInDate" className='font-medium'>From</label>
                ...
                <div className='flex flex-col'>
                    <label htmlFor="checkOutDate" className='font-medium'>To</label>
